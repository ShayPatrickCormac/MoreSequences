...
def run_test_make_simple_string():
    ...
    # Test 1
    expected = '5-6-7-8-9-10-11-12-13-'
    answer = make_simple_string(5, 13)
    print('Test 1 expected:',expected)
    print('Actual         :',answer)

    # Test 2
    expected = '1-2-3-4-5-6-7-'
    answer = make_simple_string(1, 7)
...
def run_test_make_less_simple_string():
    ...
    # Test 1
    expected = '5-6-7-8-9-10-11-12-13'
    answer = make_less_simple_string(5, 13)
    print('Test 1 expected:', expected)
    print('Actual         :', answer)

    # Test 2
    expected = '9-10-11-12-13-14-15'
    answer = make_less_simple_string(9, 15)
    print('Test 2 expected:', expected)
    print('Actual         :', answer)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        rect.append(rg.Rectangle(rg.Point(centerx-radius,centery-radius),rg.Point(centerx + radius,centery + radius)))
    return rect
